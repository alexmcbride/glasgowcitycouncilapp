...
public class ViewPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextMeta.setText(getString(R.string.view_post_text_posted, post.getUsername(), time));
    ...
    private class CommentCursorAdapter extends CursorAdapter {
        ...
        private void updateView(View view, Cursor cursor) {
            ...
            CharSequence posted = DateUtils.getRelativeTimeSpanString(comment.getPosted().getTime(),
                    System.currentTimeMillis(),
                    DateUtils.SECOND_IN_MILLIS);

            textComment.setText(comment.getContent());
            textMeta.setText(getString(R.string.comment_meta, comment.getUsername(), posted));
        }
    }
}
